...
public class HomePageTest extends CustomerBaseTest {
	...
	public void case_HM_005() {
		...
		Assert.assertTrue(wait
				.until(ExpectedConditions
						.presenceOfElementLocated(By.cssSelector("[data-testid='home-search-submit']")))
				.getText().contains("Tìm chuyến"));
	...
	public void case_HM_008() {
		...
		Assert.assertTrue(wait
				.until(ExpectedConditions
						.presenceOfElementLocated(By.cssSelector("[data-testid='customer-home-subtitle']")))
				.getText().contains("Nhanh chóng - An toàn - Tiện lợi"));
	...
	public void case_HM_009() {
		...
		Assert.assertFalse(driver.findElements(By.cssSelector("[data-testid='customer-home-feature-0']")).isEmpty(),
				"Missing element");
		Assert.assertFalse(driver.findElements(By.cssSelector("[data-testid='customer-home-feature-1']")).isEmpty(),
				"Missing element");
		Assert.assertFalse(driver.findElements(By.cssSelector("[data-testid='customer-home-feature-2']")).isEmpty(),
				"Missing element");
